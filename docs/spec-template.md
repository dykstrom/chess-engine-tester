...
Delete this section if the choice is obvious.
-->
...
<!--
Unresolved decisions or things to validate before or during implementation.
Delete this section when all questions are answered.
-->
